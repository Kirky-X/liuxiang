...
- ARS `claim_verification_protocol.md` — existing integrity verification that this checklist extends.
- ARS `integrity_review_protocol.md` — existing integrity review protocol that Stage 2.5 follows.
