...
When `gold_set_path` is non-null, the agent enters calibration mode (modeled on `../references/calibration_mode_protocol.md` and detailed in `../references/claim_audit_calibration_protocol.md`).
