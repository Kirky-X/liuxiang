...
**Backpointer**: see [`../references/literature_corpus_consumers.md`](../references/literature_corpus_consumers.md) for the full consumer protocol, BAD/GOOD examples, and shared template.
