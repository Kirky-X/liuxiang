...
If the user wants to track their progress, offer to generate a pre-filled `../templates/revision_tracking_template.md` with all parsed comments already entered.
